    ...
    <div class='homepage-main maxw'>
        <div class='homepage-main-hero-full section-text-button'>
            <div class='homepage-main-title'>
                <h4 class='title-firstline'>Információ</h4>
                <h1 class='title-secondline-h1 greencolor'>A sütikről</h1>
            </div>
            <p class='section-paragraph-gray'>Ezen az alodalon szeretnénk ismertetni az oldalunkon működő sütikezelést.</p>
            <div class="col-md-8">
                <article class="blog-content">
                    <div class="entry-content">
                        ...
                        <div id="cookieAlertBoxDetails">
                            ...
                            <a href="https://www.facebook.com/help/cookies/" style="padding-bottom: 20px;">Facebook cookies</a>
                        </div><br>
                        &nbsp;<p></p>
                    </div>
                </article>
